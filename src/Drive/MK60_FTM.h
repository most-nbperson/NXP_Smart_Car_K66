...
/**********************************  FTM(引脚复用) ***************************************/
//   PWM输出通道    端口          可选范围              建议
#define FTM0_CH0    PTC1        //PTC1、PTA3            PTA3不要用（与JLINK冲突）(电机PTC1)
#define FTM0_CH1    PTC2        //PTC2、PTA4            (电机PTC2）
#define FTM0_CH2    PTC3        //PTC3、PTA5            (电机PTC3）
#define FTM0_CH3    PTC4        //PTC4、PTA6            (电机PTC4）
...
#define FTM3_CH6    PTC10       // PTE11、PTC10     (舵机PTC10)
